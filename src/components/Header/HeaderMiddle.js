...
class HeaderMiddle extends Component {
  ...
  handleClick = () => {
    ...
    // this.props.history.push(`/keyword=${textSearch}`);
    this.setState({
      textSearch: null
    })
    doneLoading();
          ...
          <div className="row">
            ...
            <div className="col-lg-9 pl-0 ml-sm-15 ml-xs-15">
              ...
              <form className="hm-searchbox">
                <input name="textSearch" value={textSearch} type="text" onChange={this.handleChange} placeholder="Search by name, brand name, country" />
